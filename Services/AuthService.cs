...
namespace AuthService.Services
{
    public class AuthService : IAuthService
    {
        ...
        public async Task<string> RegisterAsync(RegisterRequest req)
        {
            ...
            {
                _logger.LogError(ex, "Error occurred while registering user {Username}", req.Username);
                throw; // rethrow to be handled by global exception middleware
            }
        }
        ...
        public TokenResponse Login(LoginRequest req)
        {
            ...
            {
                _logger.LogError(ex, "Error occurred during login for {Email}", req.Email);
                throw;
            }
        }
